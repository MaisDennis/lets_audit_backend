...
class U_U {
    execute({ id, id_proposal, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result) {
                const relevanceOnUsersResult = yield prismaClient_1.prisma.relevancesOnUsers.findMany({
                    where: {
                        id_proposal: id_proposal,
                    }
                });
                const relevanceCountResult = yield prismaClient_1.prisma.proposals.update({
                    where: {
                        id: id_proposal,
                    },
                    data: {
